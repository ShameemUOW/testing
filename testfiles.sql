...
SELECT DISTINCT EmployeeID, FullName, Address, Email, Mobile, chatid, MaxHours, Job, NoOfHrsWorked FROM useraccount NATURAL JOIN employeeshiftinformation NATURAL JOIN userprofile WHERE address LIKE '%America%';
